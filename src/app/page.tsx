...
export default function Home() {
  ...
  const handleLocationSelect = (loc: LocationResult) => {
    ...
    setSearchDisplay(loc.displayName);
    try { localStorage.setItem("equiprent_site_location", JSON.stringify({ city: loc.city, state: loc.state, display: loc.displayName })); } catch { /* ignore */ }
  };
